---
title: Pi 系列 04｜Tool 系统(上)：一个 toolCall 的一生
date: 2026-06-11 00:00:00 +0800
categories: [Tech, Agent]
tags: [pi, agent-harness, tool, tool-calling, agent-loop, llm]
---

前三篇可以先看 

[Pi 系列 01｜用最小例子看 agent runtime 的事件流](/posts/pi-step-zero-event-stream/)

[Pi 系列 02｜Agent loop 与 turn](/posts/pi-agent-loop-and-turn/) 

[Pi 系列 03｜Provider 抽象与统一事件协议](/posts/pi-provider-abstraction/)
...
![tool failed](/assets/img/2026-06-11_1.png)
...
![Tool 与 LLM 的关系](/assets/img/2026-06-11_2.png)
...
![执行顺序策略](/assets/img/2026-06-11_8.png)
...
![prepareToolcall关卡](/assets/img/2026-06-11_7.png)
...
![四条错误路，一个出口](/assets/img/2026-06-11_3.png)
...
![banana 处理](/assets/img/2026-06-11_6.png)
...
![机制由 loop 给，策略由上层填](/assets/img/2026-06-11_4.png)
...
![一个 toolCall 的完整一生](/assets/img/2026-06-11_5.png)
